...
from moco.rs_transforms import RandomChannelDrop, RandomBrightness, RandomContrast, ToGray
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.aug_plus:
        ...
        augmentation = cvtransforms.Compose([
            ...
            cvtransforms.RandomApply([moco.loader.GaussianBlur([.1, 2.])], p=0.5),
